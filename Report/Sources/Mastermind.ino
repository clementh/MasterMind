 ...
 * @param playerAnswer [tableau de type char] tableau contenant la réponse du 
 * joueur
 */
 ...
 * @param Answer [tableau de type char] contenant la réponse secrète
 */
 ...
 * 
 * @param text [chaine de caractères] c'est l texte à afficher.
 */
...
int *GetResults(char *secretAnswer, char *playerAnswer){
    ...
    /**
     * Si toutes les lettres sont bien placées on ne vérifie pas si il y en a des mal placées
     */
    if (result[0] != 4)
    {
 ...
 * 
 * @param  secretAnswer [tableau de char] tableau a verifier
 * @param  tmp          [char] lettre a comparer
